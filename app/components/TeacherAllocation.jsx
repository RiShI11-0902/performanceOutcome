...
export default function TeacherAllocation() {
  ...
  return (
    <div className="flex-1 overflow-x-auto">
      <h1 className="text-3xl font-bold my-4 text-center">Teacher Allocation</h1>
      <form onSubmit={handleSubmit}>
        <table className="w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr>
              <td className="border p-2"><input type="text" name="teacherName" value={formData.teacherName} onChange={handleChange} required /></td>
              <td className="border p-2"><input type="text" name="courseName" value={formData.courseName} onChange={handleChange} required /></td>
              <td className="border p-2"><input type="text" name="courseCode" value={formData.courseCode} onChange={handleChange} required /></td>
              <td className="border p-2"><input type="text" name="className" value={formData.className} onChange={handleChange} required /></td>
              <td className="border p-2"><input type="text" name="section" value={formData.section} onChange={handleChange} required /></td>
              <td className="border p-2"><input type="text" name="batch" value={formData.batch} onChange={handleChange} required /></td>
              <td className="border p-2 text-center"><input type="checkbox" name="isCoordinator" checked={formData.isCoordinator} onChange={handleChange} /></td>
              <td className="border p-2 text-center"><input type="checkbox" name="isClassIncharge" checked={formData.isClassIncharge} onChange={handleChange} /></td>
